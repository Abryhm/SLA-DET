...
Clone repo:
```
git clone https://github.com/Abryhm/SLA-DET
cd SLA-DET
```
...
# Dataset 
Large Leukemia dataset can be downloaded from the given link: 
https://drive.google.com/drive/folders/1VJSM5d1ndKtz4AQy7zQfnVGyiyGjRl8W?usp=sharing
...
Phase 1: Model pre-train # 50 Epochs
